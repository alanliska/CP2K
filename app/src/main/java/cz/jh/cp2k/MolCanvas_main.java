...
public class MolCanvas_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toCp2k = (Button) findViewById(R.id.toCp2k);
        toCp2k.setOnClickListener(toCp2kClick);
    ...
    public void alertZmat(){
        ...
        editText100.setText(colorized_numbers(exec("cat "+getFilesDir()+"/Coordinates.gjf.tmp")), EditText.BufferType.SPANNABLE);
...
//                .setView(scrollview)
    ...
    private View.OnClickListener toCp2kClick; {
        toCp2kClick = new View.OnClickListener() {
            public void onClick(View v) {
